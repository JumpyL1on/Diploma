...
{
    public class DeleteTeamMemberHandler : BaseHandler, IRequestHandler<DeleteTeamMemberCommand, Unit>
    {
        public DeleteTeamMemberHandler(DbContext dbContext) : base(dbContext)
        {
        }
