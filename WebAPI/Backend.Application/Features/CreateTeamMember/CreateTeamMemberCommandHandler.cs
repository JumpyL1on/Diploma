...
public class CreateTeamMemberCommandHandler : BaseCommandHandler,
    IRequestHandler<CreateTeamMemberCommand, CreateTeamMemberResponse>
{
    private UserManager<AppUser> UserManager { get; }

    public CreateTeamMemberCommandHandler(DbContext dbContext, UserManager<AppUser> userManager) : base(dbContext)
    {
