...
public class CreateTeamCommandCommandHandler : BaseCommandHandler, IRequestHandler<CreateTeamCommand, Guid>
{
    private UserManager<AppUser> UserManager { get; }

    public CreateTeamCommandCommandHandler(DbContext dbContext, UserManager<AppUser> userManager) : base(dbContext)
    {
